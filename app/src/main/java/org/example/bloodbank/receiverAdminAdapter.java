...
public class receiverAdminAdapter extends RecyclerView.Adapter<receiverAdminAdapter.ExperienceViewHolder>{
            ...
            public void onClick(View view) {
                if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.M) {
                    if (act.checkSelfPermission(Manifest.permission.CALL_PHONE) != PackageManager.PERMISSION_GRANTED) {
                        showCallPermissionAlert(act.getApplicationContext(), act);
                    }
                    Intent intent = new Intent(Intent.ACTION_DIAL);
                    intent.setData(Uri.parse(number[position]));
    ...
    public class ExperienceViewHolder extends RecyclerView.ViewHolder{
        ...
        public ExperienceViewHolder(@NonNull View itemView,AppCompatActivity activity) {
            ...
            callbutton=itemView.findViewById(R.id.cbutton);
        }
    ...
    private void showCallPermissionAlert(Context context, AppCompatActivity activity){
